...
### Technology Overview
  #### AWS Networking
    ...
    - VPC: a logically isolated part of the AWS Cloud where you can launch AWS resources
    - Internet Gateway: Enable access to the internet
    - Route Tables: determine where network traffic from the subnets are routed
    - NACLs: act as firewalls to the **subnet** level
    - Security Groups: acts as a firewall at the instance level
    - Subnets: logical partition of an IP network into multiple, smaller segments
